...
# Plotly API
plotly.tools.set_credentials_file(username = 'kessenma', api_key = 'yu3Xxdv6Un6BY5eFsLes')
...
try:
	...
	saveFile = open('Weatherdata.txt','w')
...
cache_fname= "Weatherdata.txt"
try: 
	cache_file = open(cache_fname,'r') #reads file
	cache_contents = cache_file.read()
